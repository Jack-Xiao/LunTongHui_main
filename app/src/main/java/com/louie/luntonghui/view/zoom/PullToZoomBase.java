...
public abstract class PullToZoomBase<T extends View> extends LinearLayout implements IPullToZoom<T> {
    ...
    protected View mFooterView; //add footer view
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        if(attrs !=null){
            ...
            int footerViewResId = a.getResourceId(R.styleable.PullToZoomView_footerView,0);
            if(footerViewResId < 0){
                mFooterView = mLayoutInflater.inflate(footerViewResId,null,false);
            }
    ...
    public boolean isHideFooter() {return isHideFooter; }
    ...
    public void setHideFooter(boolean isHideFooter){
        this.isHideFooter = isHideHeader;
    }
