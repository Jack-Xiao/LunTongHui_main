 ...
 */
public class TogetherGroupActivit1 extends BaseToolbarActivity{
    ...
    private class GetPrepayIdTask extends AsyncTask<Void, Void, Map<String,String>> {
        ...
        protected void onPreExecute() {
            dialog = ProgressDialog.show(TogetherGroupActivit1.this, "1", "2");
    ...
    private String getProductArgs(){
        ...
        try {
            ...
            Log.e(TogetherGroupActivit1.class.getSimpleName(),error);
            return null;
        }
    }
