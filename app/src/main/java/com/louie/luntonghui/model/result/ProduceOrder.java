 ...
 */
public class ProduceOrder extends Result implements Parcelable {
    ...
    public static class ConsigneeEntity implements Parcelable {
    ...
    public static class CartGoodsEntity implements Parcelable {
        public String gysmoney;
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeString(this.discounta);
            ...
            dest.writeString(this.discount_name);
            dest.writeString(this.discount_time);
            dest.writeString(this.goods_name);
    ...
    public static class PaymentListEntity implements Parcelable {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeString(this.pay_desc);
            dest.writeInt(this.sel);
        }
    ...
    protected ProduceOrder(Parcel in) {
        ...
        //this.shipping_list = in.readArrayList()
    ...
    public static final Parcelable.Creator<ProduceOrder> CREATOR = new Parcelable.Creator<ProduceOrder>() {
        ...
        public ProduceOrder[] newArray(int size) {
            return new ProduceOrder[size];
        }
    };
}
/*
